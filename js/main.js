...
var waited_develop=function(){
    ...
    for (var i=4;i<waitedli.length;i++){
...
var canvasc2=document.getElementById("c2").getContext("2d");
var canvasJAVA=document.getElementById("JAVA").getContext("2d");
...
var canhtml5=function(){
    ...
    var html5T = function(deg){
        ...
        canvashtml5.strokeStyle = "#aa0000"; 
...
var canc2=function(){
	var deg = 0;
    var c2T = function(deg){
        var r = deg*Math.PI/180;   
        canvasc2.clearRect(0,0,canwidth,canwidth);   
        canvasc2.beginPath();  
        canvasc2.strokeStyle = "#ffa500"; 
        canvasc2.lineWidth = 10; 
        canvasc2.arc(canwidth/2,canwidth/2,radius,0-1/2*Math.PI,r-1/2*Math.PI,false); //
        canvasc2.stroke();
    };
    var time = setInterval(function(){
    	var con=document.getElementsByTagName("section")[2];
...
var canJAVA=function(){
	var deg = 0;
    var JAVAT = function(deg){
        var r = deg*Math.PI/180;   
        canvasJAVA.clearRect(0,0,canwidth,canwidth);   
        canvasJAVA.beginPath();  
        canvasJAVA.strokeStyle = "#005500"; 
        canvasJAVA.lineWidth = 10; 
        canvasJAVA.arc(canwidth/2,canwidth/2,radius,0-1/2*Math.PI,r-1/2*Math.PI,false); //
        canvasJAVA.stroke();
    };
    var time = setInterval(function(){
    	var con=document.getElementsByTagName("section")[2];
